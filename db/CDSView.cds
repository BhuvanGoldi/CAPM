...
using { datamodel.db.master, datamodel.db.transaction } from './datamodel';
...
context CDSViews {
    ...
    select from transaction.poitems{
        ...
        PRODUCT_GUID.SUPPLIER_GUID as![SupplierName]
       /* {
            select from db.master.product as a 
            {
                WEIGHT_MEASURE as![WeightMeasure]
            }
            where a.NODE_KEY = db.transaction.poitems.NODE_KEY
        }*/
